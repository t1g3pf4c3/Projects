...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  ...
  'unifunc' => 'content_616bb66857adc5_22938950',
...
function content_616bb66857adc5_22938950 (Smarty_Internal_Template $_smarty_tpl) {
...
">
			...
			<img class="header_logo" src="/files/logo.png">
				...
				<div class="navbar-header">
					...
					<p> ЖУРНАЛ <br></p>
						<h1 class="site-name">
					<?php } else { ?>
						<div class="site-name" style="margin-top:20px;">
					<?php }?>
...
">
												<ul>
						<li> <a href="/index.php"> <img src="/files/home.svg"> </a> </li>
						<li> <a href="/index.php/SAU/about"> О ЖУРНАЛЕ</a></li>
						<li> <a href="/index.php/SAU/issue/current"> ТЕКУЩИЙ ВЫПУСК </a></li>
						<li> <a href="/index.php/SAU/issue/archive"> АРХИВ</a></li>
						<li  style="width:100px;"></li>
						<li> <a href="/index.php/SAU/user/profile">  <img src="/files/user.svg"></a></li>
						<li> <a href="/index.php/SAU/login/signOut">  <img src="/files/exit.svg"></a></li>
			...
			<main class="pkp_structure_main col-xs-12 " role="main">
...
header{
	background-image: linear-gradient(120deg, #ff6d00, #a1a6c4);	
}
.navbar-toggle{
	position:absolute;
	right:0;
...
.navbar-default .navbar-toggle:hover, .navbar-default .navbar-toggle:focus, .header_view .navbar-toggle:hover, .header_view .navbar-toggle:focus,.navbar-default .navbar-toggle, .header_view .navbar-toggle {
    border-color: transparent;
	margin-top:2px;
	margin-right:0;
