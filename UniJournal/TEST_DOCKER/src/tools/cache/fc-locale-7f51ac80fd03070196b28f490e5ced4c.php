<?php return array (
  ...
  'admin.settings.appearance.success' => 'Настройки оформления сайта были успешно обновлены.',
  'admin.settings.config.success' => 'Настройки конфигурации сайта были успешно обновлены.',
  'admin.settings.info.success' => 'Информация сайта была успешно обновлена.',
...
<p>Языковые пакеты могут быть вручную скачаны с <a href="http://pkp.sfu.ca">веб-сайта PKP</a>.</p>',
  ...
  'admin.contexts.form.create.success' => '{$name} был успешно создан.',
  'admin.contexts.form.edit.success' => '{$name} был успешно отредактирован.',
