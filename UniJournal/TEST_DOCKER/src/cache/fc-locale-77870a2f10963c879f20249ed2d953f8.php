<?php return array (
  ...
  'plugins.reports.reviews.dateAcknowledged' => 'Дата подтверждения получения',
  'plugins.reports.reviews.unconsidered' => 'Нерассмотрен',
  'plugins.reports.reviews.dateCompleted' => 'Дата окончания',
  'plugins.reports.reviews.dateReminded' => 'Дата напоминания',
  'plugins.reports.reviews.reviewOverdue' => 'Превышение срока рецензирования в днях',
  'plugins.reports.reviews.responseOverdue' => 'Превышение срока ответа в днях',
