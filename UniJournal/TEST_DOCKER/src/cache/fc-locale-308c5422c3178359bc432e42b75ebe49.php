<?php return array (
  ...
  'plugins.importexport.medra.crossref' => 'Deposit to Crossref. (This service must be enabled for your account.)',
  'plugins.importexport.medra.crossref.error.cause' => 'Cause: file not valid in respect to the mEDRA and/or Crossref requirements.',
  'plugins.importexport.medra.crossref.error.number' => 'Number of errors',
  'plugins.importexport.medra.crossref.error.details' => 'The following requirements were not met',
  'plugins.importexport.medra.crossref.error.code' => 'CODE',
  'plugins.importexport.medra.crossref.error.element' => 'ELEMENT',
  'plugins.importexport.medra.crossref.error.description' => 'DESCRIPTION',
